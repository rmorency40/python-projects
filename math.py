...
# Compute the costs for 20  servers.
...
print('Cost to operate one server per day is ${:.2f}.' .format(cost_per_day))
print('Cost to operate one server per month is ${:.2f}' .format(cost_per_month))
print('Cost to operate 20 servers per day is ${:.2f}' .format(cost_per_day_twenty))
print('Cost to operate 20 servers per month is ${:.2f}' .format(cost_per_month_twenty))
